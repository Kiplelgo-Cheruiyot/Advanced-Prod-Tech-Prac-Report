...
Figure \ref{fig:scanned} shows the 3D model obtained from the scans.
 \begin{center}
 	\begin{figure}[!h]
 	\centering
 	\includegraphics[width=0.55\linewidth]{Figures/Figure 1}
...
\begin{figure}[!h]%
	\centering
	\subfloat[\centering Isometric View]{{\includegraphics[width=5cm]{Figures/Result0} }}%
	\qquad
	\subfloat[\centering Top View]{{\includegraphics[width=5cm]{Figures/Result1} }}%
